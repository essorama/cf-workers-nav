...
const config = {
  ...
  search_engine:[                     //choose search engine which you use
    ...
    {
      name:"微信",
      template:"https://weixin.sogou.com/weixin?type=2&s_from=input&query=$s"
    },
    {
      name:"知乎",
    ...
    {
      name:"知网",
      template:"https://search.cnki.com.cn/Search/Result?content=$s"
    },
    {
      name:"F搜",
  ...
  lists: [                            //Url list
...

    {
      ...
      list:[
        ...
        {
          url:"https://www.wanrenmi8.com/cn/",
          name:"万人迷吧",
          desc:"云盘搜索"
        },
...
/*function getFavicon(url){
  if(url.match(/https{0,1}:\/\//)){
    return "https://www.dnspod.cn/favicon.ico?domain=" + url.split('//')[1];
  }else{
    return "https://www.dnspod.cn/favicon.ico?domain=" + url;
  } 
}*/
/*
*/
function getFavicon(url){
  if(url.match(/https{0,1}:\/\//)){
    return "https://api.iowen.cn/favicon/" + url.split('//')[1] + ".png";
  }else{
    return "https://api.iowen.cn/favicon/http://" + url + ".png";
  } 
}
